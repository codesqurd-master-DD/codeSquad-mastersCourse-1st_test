...
그 외에 회전은 step-2를 응용하면 될거같지만 회전하면서 옆에 면들을 같이 움직이게 하는게 좀 복잡하다.  
...
앞서 수행한 1, 2단계 논리를 3단계에 적용하지 못 하고 새로운 방법으로 큐브를 돌리고, 옮겨서 좀 아쉽다. 처음부터 3단계까지 철저하게 고려해서 1, 2단계를 진행했다면 재사용성을 높일 수 있었을텐데..
